...
Window::Window() : implementation(new ImplementationWindow) {
  implementation->make();
}
void Window::flip() { implementation->flip(); }
unsigned Window::width() { return implementation->width; }
unsigned Window::height() { return implementation->height; }
